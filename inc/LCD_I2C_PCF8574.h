...
//
// This library is derived from the original Arduino
// LiquidCrystal library and uses the original Wire
...
//Aqui guardo los string porque no puedo leer del LCD con el PCF8574
static uint8_t LCD_Texto[4][20];
...
/*=======================[Prototipos de funciones del I2C]====================================*/
  ...
  void setup_LCD_I2C_PCF8574(uint8_t adr, uint8_t cols, uint8_t lines, uint8_t charsize);
  ...
  void createChar( uint8_t, uint8_t[] );   ///Luego la implemento
